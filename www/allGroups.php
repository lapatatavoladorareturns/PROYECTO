            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    for (let i of data.msg) {
                        let li = $(`<tr class='w-100 hoverable rounded' data-id=${i.id}></tr>`);
                        li.append($("<td></td>").text(i.groupName));
                        li.append($("<td></td>").text(i.numMiembros));
                        li.append($("<td></td>").text(i.numKdds));
                        /*li.append($("<td></td>").text(i.title));
                        li.append($("<td style='overflow-y: scroll'></td>").text(i.desc));
