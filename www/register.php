                            ...
                            <div class="face frontrounded rounded" style="background-color: #3B707D">
                                ...
                                <form id="login" autocomplete="on" class="card-body m-1" style="background-color: #3B707D">
                                    ...
                                    <div class="md-form">
                                        ...
                                        <input type="text" name="username" class="form-control validate text-light" required>
                                    ...
                                    <div class="md-form">
                                        ...
                                        <input type="password" id="password" name="password" class="form-control validate text-light" required>
                                        <label for="password" class="d-flex text-light font-weight-bold ">Contraseña</label>
                                    </div>

                                    <div class="md-form">
                                        <i class="fas fa-lock prefix d-flex"></i>
                                        <input type="password" id="password2" name="password2" class="form-control text-light" required>
                                        <label for="password2" class="d-flex text-light font-weight-bold">Confirmar contraseña</label>
                                    </div>
